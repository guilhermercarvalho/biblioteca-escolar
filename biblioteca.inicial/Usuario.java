...
public class Usuario
{
  ...
  */
  public void listaLivrosEmprestados() {
    ...
    if(cont != 0){
      ArrayList<Livro> livrosUsuario = new ArrayList<>();
      livrosUsuario.addAll(livrosEmprestados);
      Collections.short(livrosUsuario);
      for(Livro p : livrosEmprestados){
        p.imprimeInformacoesLivro();
      }
    }
